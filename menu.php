...
<?php
	...
	$requete7 = ("SELECT prix_menu FROM menu WHERE nomMenu = ?");
...
<?php
	//afficher plat menu terroir
 	$requete3 = ("SELECT nomPlat FROM menu, plat_menu, plat WHERE menu.id_menu= plat_menu.id_menu_menu AND  plat.id_plat = plat_menu.id_plat_menu AND nomMenu = ?");
 	//on prepare la requete dans $req
...
//affiche prix menu tradition
	...
	<button class="bouton"><a href="menu1.php">Menu suivant</a></button><br/>
